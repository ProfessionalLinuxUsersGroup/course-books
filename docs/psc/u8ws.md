...
- <a href="https://professionallinuxusersgroup.github.io/course-books/assets/psc/downloads/u8/u8_worksheet.txt" target="_blank">📥 u8_worksheet(`.txt`)</a>
- <a href="https://professionallinuxusersgroup.github.io/course-books/assets/psc/downloads/u8/u8_worksheet.pdf" target="_blank">📥 u8_worksheet(`.pdf`)</a>

### Unit 8 Recording

<iframe
    style="width: 100%; height: 100%; border: none; aspect-ratio: 16/9; border-radius: 0.25rem; background:black;"
    src="https://www.youtube.com/embed/C5F6i9zDgJ4"
