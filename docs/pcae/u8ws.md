...
- <a href="../../assets/pcae/downloads/u8/u8_worksheet.md.txt" target="_blank" download="u8_worksheet.md">:material-download: u8_worksheet.md</a>
- <a href="../../assets/pcae/downloads/u8/u8_worksheet.txt" target="_blank" download>:material-download: u8_worksheet.txt</a>
- <a href="../../assets/pcae/downloads/u8/u8_worksheet.pdf" target="_blank" download>:material-download: u8_worksheet.pdf</a>
...
automation?
2. What pieces of information will the team need to supply on their side for each
deployment?
	1. How can the different dev teams feed this into your automation?
	2. What do you prefer?
3. What are some potential default variables you would want to use for this
deployment?
...
https://docs.ansible.com/projects/ansible/latest/collections/kubernetes/core/k8s_module.html
	...
	2. Do you have another tool you’d use instead of this? Does it have the same, or
	more functionality?
2. Deployment practices with Kubernetes blue/green and canary labs:
	...
	2. <https://killercoda.com/het-tanis/course/Kubernetes-Labs/canary-deployments>
