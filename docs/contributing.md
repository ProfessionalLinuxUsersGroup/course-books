...
needing to clone the base respository separately. Suppose one worktree is created to work on feature "x",
and a separate worktree is implemented for bug "y", all localized in the same repository.
